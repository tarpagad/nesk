          ...
          <form onSubmit={handleSearch} className="gap-4 grid md:grid-cols-12">
            <div className="md:col-span-6">
              <input
                ...
                className="block shadow-sm dark:shadow-gray-900 px-3 py-2 border border-gray-300 dark:border-gray-600 focus:border-blue-500 rounded-md focus:outline-none focus:ring-blue-500 w-full"
              />
            </div>
          ...
          <div className="gap-6 grid">
            {articles.map((article) => (
              <Link
                key={article.id}
                href={`/kb/${article.id}`}
                className="block bg-white dark:bg-gray-800 shadow dark:shadow-gray-900 hover:shadow-lg p-6 border border-gray-200 dark:border-gray-700 rounded-lg transition-shadow dark:shadow-gray-900"
              >
                <div className="flex justify-between items-start mb-3">
                  <h2 className="flex-1 font-semibold text-gray-900 dark:text-gray-100 text-xl hover:text-blue-600">
                    {article.title}
                  </h2>
                  {article.category && (
                    <span className="ml-4 bg-blue-100 px-3 py-1 rounded-full font-medium text-blue-800 dark:text-blue-400 text-sm">
